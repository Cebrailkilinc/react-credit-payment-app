...
function Installment() {
    ...
    return (
        <div className='mt-10 sm:mt-16 flex flex-col  '>
            ...
            <input type="number" onChange={(e)=>{setVadeSayisi(e.target.value)}}  placeholder='Vade Sayısı' className='border h-12 p-2 w-28 sm:w-56  my-2 sm:my-5 focus:outline-none ' />
